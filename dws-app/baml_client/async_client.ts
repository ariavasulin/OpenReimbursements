...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.ExtractedReceipt> {
          try {
          ...
          if (options.onTick) {
          const stream = this.stream.ExtractReceiptFromImage(
          img,
          __baml_options__
          );
          ...
          const env: Record<string, string> = Object.fromEntries(
            ...
            return raw.parsed(false) as types.ExtractedReceipt
            } catch (error) {
            ...
            img: Image,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.ExtractedReceipt, types.ExtractedReceipt>
              {
              try {
              const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const signal = options.signal;
              ...
              console.error("Error in onTick callback for ExtractReceiptFromImage", error);
              }
              }
              };
              }
              ...
              const env: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.ExtractedReceipt, types.ExtractedReceipt>(
                  raw,
                  (a): partial_types.ExtractedReceipt => a,
                  (a): types.ExtractedReceipt => a,
                  this.ctxManager.cloneContext(),
                  options.signal,
                  )
                  } catch (error) {
